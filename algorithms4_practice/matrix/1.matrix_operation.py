...
#
from algorithms4.matrix import matrix_operation
...
def main():
    ...
    print('Add Operation, %s + %s = %s \n' %(matrix_a, matrix_b, (matrix_operation.add(matrix_a, matrix_b))))
    print('Multiply Operation, %s * %s = %s \n' %(matrix_a, matrix_b, matrix_operation.multiply(matrix_a, matrix_b)))
    print('Identity:  %s \n' %matrix_operation.identity(5))
    print('Minor of %s = %s \n' %(matrix_c, matrix_operation.minor(matrix_c, 1, 2)))
    print('Determinant of %s = %s \n' %(matrix_b, matrix_operation.determinant(matrix_b)))
    print('Inverse of %s = %s\n'%(matrix_d, matrix_operation.inverse(matrix_d)))
