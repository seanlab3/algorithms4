...
15
15 found at positions: 4


"""
from algorithms4.searches import binary_search
...
try:
    binary_search.__assert_sorted(collection)
except ValueError:
    sys.exit('Sequence must be ascending sorted to apply binary search')

target_input = input('Enter a single number to be found in the list:\n')
target = int(target_input)
result = binary_search.binary_search(collection, target)
