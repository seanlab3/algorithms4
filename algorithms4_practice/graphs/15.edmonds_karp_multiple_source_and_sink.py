...
from algorithms4.graphs import edmonds_karp_multiple_source_and_sink
...
# prepare our network
flowNetwork = edmonds_karp_multiple_source_and_sink.FlowNetwork(graph, entrances, exits)
# set algorithm
flowNetwork.setMaximumFlowAlgorithm(edmonds_karp_multiple_source_and_sink.PushRelabelExecutor)
# and calculate
