...
#     else:
#         print('Not found')
from algorithms4.searches import interpolation_search
...
print(collection)
try:
    interpolation_search.__assert_sorted(collection)
except ValueError:
    sys.exit('Sequence must be ascending sorted to apply interpolation search')
...
result = interpolation_search.interpolation_search(collection, target)
if result is not None:
    print('{} found at positions: {}'.format(target, result))
else:
    print('Not found')
