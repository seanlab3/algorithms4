...
from algorithms4.data_structures.binary_tree import lca
...
level, parent = lca.bfs(level, parent, max_node, graph, 1)
parent = lca.creatSparse(max_node, parent)
print("LCA of node 1 and 3 is: ", lca.LCA(1, 3, level, parent))
print("LCA of node 5 and 6 is: ", lca.LCA(5, 6, level, parent))
print("LCA of node 7 and 11 is: ", lca.LCA(7, 11, level, parent))
print("LCA of node 6 and 7 is: ", lca.LCA(6, 7, level, parent))
print("LCA of node 4 and 12 is: ", lca.LCA(4, 12, level, parent))
print("LCA of node 8 and 8 is: ", lca.LCA(8, 8, level, parent))
