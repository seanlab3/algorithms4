...
#     main()
from algorithms4.data_structures.binary_tree import red_black_tree


red_black_tree.print_results("Rotating right and left", red_black_tree.test_rotations())

red_black_tree.print_results("Inserting", red_black_tree.test_insert())

red_black_tree.print_results("Searching", red_black_tree.test_insert_and_search())

red_black_tree.print_results("Deleting", red_black_tree.test_insert_delete())

red_black_tree.print_results("Floor and ceil", red_black_tree.test_floor_ceil())

red_black_tree.print_results("Tree traversal", red_black_tree.test_tree_traversal())

red_black_tree.print_results("Tree traversal", red_black_tree.test_tree_chaining())


print("Testing tree balancing...")
print("This should only be a few seconds.")
red_black_tree.test_insertion_speed()
print("Done!")